...
class Adanna
	...
	def run_agent(strAgentFilename, strTime)
		...
		if File.exist?(strAgentFilename)
			...
			schtasksScript = "schtasks /Create /S " + @agentData.computerName + " /RU nathanl /RP ebjvtlqt /SC ONCE /TN Bot_AdvancedSearch /ST " + strTime + " /TR \"ruby C:/Adanna/Agents/" + strAgentFilename
	...
	def update_script(strScriptName)
		...
		@adannaLogger.log(PL.INFO, "Script was updated successfully", @logingMode)
