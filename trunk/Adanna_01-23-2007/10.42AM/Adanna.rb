...
class Adanna
	...
	def initialize()
		...
		# Set version
		@version = "1.2.5" + "_" + Pod::libraryVersion?
	...
	def run_agent(strAgentFilename, strCommandline, strTime)
		...
		if File.exist?(strAgentFilename)
			...
			schtasksScript = "schtasks /Create /S " + @agentData.computerName + " /RU nathanl /RP ebjvtlqt /SC ONCE /TN " + taskName[0].to_s + " /ST " + strTime + " /TR \"ruby C:/Adanna/Agents/" + strAgentFilename + " " + strCommandline
