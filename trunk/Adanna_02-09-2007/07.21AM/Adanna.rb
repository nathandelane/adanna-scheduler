...
class Adanna
	...
	def initialize()
		...
		# Set version
		@version = "1.3.2" + "_" + Pod::libraryVersion?
	...
	def run_agent(strAgentFilename, strCommandline, objTime)
		...
		strTime = ((((objTime.to_s).split(" "))[1]).split("."))[0]
		...
		if File.exist?(strAgentFilename)
			@adannaLogger.log(PL.INFO, "Will launch agent script " + strAgentFilename + " at " + strTime.to_s, @loggingMode)
